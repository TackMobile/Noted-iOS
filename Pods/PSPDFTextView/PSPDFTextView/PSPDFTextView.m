...
static BOOL didBeginEditing = NO;
-(void)textViewDidBeginEditing:(UITextView *)textView {
    didBeginEditing = YES; // Unless the text view has begun editing, we don't want it to scroll to a phantom caret in textViewDidChangeSelection:
...
- (void)textViewDidChangeSelection:(UITextView *)textView {
    // this method fires when we page to another note. The text would scroll for no reason. Don't let it fire unless we have begun editing
    if (!didBeginEditing) return; 
    didBeginEditing = NO;
...
// need to forward this method in order for the fade to appear on top of the textview

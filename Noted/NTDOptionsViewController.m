...
- (void)dropboxTapped {
  ...
  if (![NTDDropboxManager isDropboxEnabledAndLinked]) { //&& [NTDDropboxManager isDropboxPurchased]) { TODO KAK
  ...
  } else if ([NTDDropboxManager isDropboxEnabledAndLinked] && [NTDDropboxManager isDropboxPurchased]) {
